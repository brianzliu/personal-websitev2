        ...
        <main className="w-full px-6 py-12 md:py-24 md:px-24 lg:px-48 xl:px-72 2xl:px-96">
            <div className="flex flex-col space-y-12 md:space-y-16">
                    ...
                    <div className="flex w-full flex-col space-y-12 md:w-2/3">
                        <div className="flex flex-col space-y-2">
                            ...
                            <div className="font-sans text-base text-neutral-600 md:text-lg">
                                ...
                                <p>GPA: 3.97/4.00</p>
                                <p className="mt-2 text-sm text-neutral-500 md:text-base">Coursework: Linear Algebra, Vector Calculus, Data Structures and Algorithms for Data Science</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col space-y-4 md:flex-row md:space-x-12 md:space-y-0">
                    ...
                    <div className="flex w-full flex-col space-y-4 md:w-2/3">
                        <div className="flex flex-col space-y-2 font-sans text-base text-neutral-600 leading-relaxed md:text-lg">
